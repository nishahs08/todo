...
function App() {
    ...
    return (
        <ThemeProvider theme={theme}>
            ...
            <Sidebar categories={categories} activeCategory={categoryFilter} setActiveCategory={(value) => setCategoryFilter(value)} hideDone={statusFilter} setHideDone={setStatusFilter} />
